...
{
    internal class CrmJsCompletionCommandHandler : IOleCommandTarget
    {
        private readonly IOleCommandTarget _mNextCommandHandler;
        private readonly ITextView _mTextView;
        private readonly CrmJsCompletionHandlerProvider _mProvider;
        ...
        internal CrmJsCompletionCommandHandler(IVsTextView textViewAdapter, ITextView textView, CrmJsCompletionHandlerProvider provider)
        {
            _mTextView = textView;
            _mProvider = provider;
