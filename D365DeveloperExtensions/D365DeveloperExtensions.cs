...
namespace D365DeveloperExtensions
{
    ...
    {
        public const string GuidD365DeveloperExtensionsPkgString = "A4FA8F78-98AF-4633-8621-BBDD7792A6AC";
        public const string GuidD365DevExCmdSetString = "95CD7B0B-0592-4683-B42C-A79A41380FFE";
        public static Guid GuidD365DeveloperExtensionsPkg = new Guid(GuidD365DeveloperExtensionsPkgString);
        public static Guid GuidD365DevExCmdSet = new Guid(GuidD365DevExCmdSetString);
    }
    /// <summary>
